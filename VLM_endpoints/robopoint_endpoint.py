...
# RoboPoint imports with detailed error logging
ROBOPOINT_AVAILABLE = False
try:
    print("Attempting to import robopoint.constants...")
    ...
    print("✓ robopoint.constants imported successfully")
    
    print("Attempting to import robopoint.conversation...")
    from robopoint.conversation import conv_templates
    print("✓ robopoint.conversation imported successfully")
    
    print("Attempting to import robopoint.model.builder...")
    from robopoint.model.builder import load_pretrained_model
    print("✓ robopoint.model.builder imported successfully")
    
    print("Attempting to import robopoint.mm_utils...")
    from robopoint.mm_utils import tokenizer_image_token, process_images, get_model_name_from_path
    print("✓ robopoint.mm_utils imported successfully")
    
    ROBOPOINT_AVAILABLE = True
    print("✓ All RoboPoint imports successful!")
    
except ImportError as e:
    print(f"✗ ImportError in RoboPoint: {e}")
    ROBOPOINT_AVAILABLE = False
except ModuleNotFoundError as e:
    print(f"✗ ModuleNotFoundError in RoboPoint: {e}")
    ROBOPOINT_AVAILABLE = False
except AttributeError as e:
    print(f"✗ AttributeError in RoboPoint: {e}")
    ROBOPOINT_AVAILABLE = False
except Exception as e:
    print(f"✗ Unexpected error importing RoboPoint: {type(e).__name__}: {e}")
    import traceback
